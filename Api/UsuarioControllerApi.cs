...
namespace juegoCartas_net.Controllers
{
    ...
    public class UsuarioControllerApi : Controller
    {
        ...
        public UsuarioControllerApi(IConfiguration configuration, IWebHostEnvironment environment, IRepositorioUsuario repositorio, IRepositorioCarta repoCarta)
        {
